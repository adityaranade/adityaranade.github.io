...
print("Mean Absolute Error:",round(mean_absolute_error(data_test["calories"],predictions)))
print("Root Mean Squared Error:",round((mean_squared_error(data_test["calories"],predictions))** 0.5),2)
```

::: {style="text-align: justify"}
Root Mean Squared Error (RMSE) of 7.18 and Mean Absolute Error (MAE) of 9.63 is decent and indicates model is performing fairly well. 
:::
