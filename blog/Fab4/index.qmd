...
![Career details for players](table.png){fig-align="center"}
...
![Credible intervals for the average runs scored per inning against each of the opposition](fab4.png)
