...
::: {style="text-align: justify"}
Next, we will try the elastic net regression which is a combination of ridge ($L^2$ penalty) and lasso ($L^1$ penalty) regression.
:::
...
::: {style="text-align: justify"}
Based on the evaluation metrics and observed vs. predicted plot, support vector machine plot seems to be the best model.
:::
